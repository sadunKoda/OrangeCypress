...
ordinoSuite("OrangeHRM  Login 1  - Test Suite",
  { tags: ["@reg", "@home"] },
  () => {
    ...
    it("Test - Verify Given Login Search Selection", { tags: "@smk" }, () => {
      loginPage
        .visitUrl()
        .step_enterUsername("Admin")
        .step_enterPassword("admin123")
    ...
    it("Test - Verify Given Login 33", { tags: "@smk" }, () => {
      loginPage
        .visitUrl()
        .step_enterUsername("Admin")
        .step_enterPassword("admin123")
     ...
     it("Test - Verify Given Menu Search Login 44", { tags: "@smk" }, () => {
      loginPage
        .visitUrl()
        .step_enterUsername("Admin")
        .step_enterPassword("admin123")
